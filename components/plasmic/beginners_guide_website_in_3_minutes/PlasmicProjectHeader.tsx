...
import sty from "./PlasmicProjectHeader.module.css"; // plasmic-import: Vc-4-mbgPrQ_/css
...
function PlasmicProjectHeader__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.columns__yIHl5)}>
        <div className={classNames(projectcss.all, sty.column__fQc14)}>
          <div
            className={classNames(
              projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.column__bUkwe)}>
          <div className={classNames(projectcss.all, sty.columns__agUEt)}>
            <div className={classNames(projectcss.all, sty.column__iN9Yp)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__rlP1)}>
                {renderPlasmicSlot({
            ...
            <div className={classNames(projectcss.all, sty.column__adZJm)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
              ...
              <div className={classNames(projectcss.all, sty.freeBox___9VXmm)}>
                {renderPlasmicSlot({
