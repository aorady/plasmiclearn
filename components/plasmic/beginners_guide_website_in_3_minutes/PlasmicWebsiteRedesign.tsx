...
import sty from "./PlasmicWebsiteRedesign.module.css"; // plasmic-import: 6VLHMOMbrWRO/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__fkBUr)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__ws9GS)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__tsw5T)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__vjYP)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__uW9Or)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__it5Qd)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__hRhPi)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__xMgwc)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__onuRo)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__cVtaW)}
                >
                  <div
                    className={classNames(projectcss.all, sty.column__nJv0Z)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__l9Ynq)}
                      displayHeight={
                  ...
                  <div
                    className={classNames(projectcss.all, sty.column__cgrEu)}
                  >
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__m5Yt)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox__ibmjF)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__bBxRp)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__vQgqq)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___2N4Qy)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__haLpN)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__xckNs)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__wi4Tz)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__om9LJ)}
              >
                <div className={classNames(projectcss.all, sty.column__moRgj)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard___97OBs
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__xmYCt)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__gy7B0
                    )}
