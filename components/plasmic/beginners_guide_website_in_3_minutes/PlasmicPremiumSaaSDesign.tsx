...
import sty from "./PlasmicPremiumSaaSDesign.module.css"; // plasmic-import: f0KE0KfGZduY/css
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__wMrnH)}
            id={"Services"}
          >
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img___711AW)}
              displayHeight={"700px"}
          ...
          <Stack__
            as={"section"}
            hasGap={true}
            className={classNames(projectcss.all, sty.section__jYzyh)}
            id={"work"}
          >
            <div className={classNames(projectcss.all, sty.freeBox__vD8Um)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__o6Ev)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__jW4Zf)}>
              <h3
                className={classNames(
                  projectcss.all,
                  projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__ohii8)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__iwtXo)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img___2BNlA)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
                ...
                <Stack__
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.columns__jEuKx)}
                >
                  <div className={classNames(projectcss.all, sty.column__ypKa)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__m6Rt9)}
                      displayHeight={
                  ...
                  <div className={classNames(projectcss.all, sty.column__z0ZQ)}>
                    <PlasmicImg__
                      alt={""}
                      className={classNames(sty.img__hbmdw)}
                      displayHeight={
                        hasVariant(globalVariants, "screen", "mobileOnly")
                          ? "300px"
                          : "600px"
              ...
              <div className={classNames(projectcss.all, sty.freeBox___5YPp3)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section__xc1Tr)}
              id={"about"}
            >
              <div className={classNames(projectcss.all, sty.freeBox___1QAgp)}>
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__ykWxu)}
                  displayHeight={"auto"}
                  displayMaxHeight={"none"}
                  displayMaxWidth={"100%"}
                  displayMinHeight={"0"}
              ...
              <div className={classNames(projectcss.all, sty.freeBox__liPhC)}>
                <h3
                  className={classNames(
                    projectcss.all,
                    projectcss.h3,
            ...
            <Stack__
              as={"section"}
              hasGap={true}
              className={classNames(projectcss.all, sty.section___6NvHe)}
              id={"contact"}
            >
              <div className={classNames(projectcss.all, sty.freeBox__hl5X)}>
                <h2
              ...
              <Stack__
                as={"div"}
                hasGap={true}
                className={classNames(projectcss.all, sty.columns__vXUuL)}
              >
                <div className={classNames(projectcss.all, sty.column__if4G9)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__rRsHt
                    )}
                    image={{
                ...
                <div className={classNames(projectcss.all, sty.column__i8E14)}>
                  <ProjectCard
                    className={classNames(
                      "__wab_instance",
                      sty.projectCard__l6Sn1
                    )}
