...
import sty from "./PlasmicContactSection.module.css"; // plasmic-import: T-Y-PLGKezVi/css
...
function PlasmicContactSection__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      id={"contact"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___4Dgw9)}>
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ifs85)}>
          <PlasmicLink__
